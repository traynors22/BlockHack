								...
								<div   class=" panel panel-default" >
									<div style = " padding-top:10px"  class="panel-body" >
										<div style = " padding-top:20px"  class = "col-md-3">
											...
											<img class= "tool1" src="https://cdn4.iconfinder.com/data/icons/pretty_office_3/256/Add-Male-User.png" height="200" width="200">
										...
										<div style= " float: right; display:inline;">
											<button  type="button" class="btn btn-success" data-toggle = "modal"  >Create Admin</button>
